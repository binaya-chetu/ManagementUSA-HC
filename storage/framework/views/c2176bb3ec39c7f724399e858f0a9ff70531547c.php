                        ...
                        <div class="tab-content">
                            <div id="marketing" class="tab-pane active">
                                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo e(URL::asset('vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf')); ?>">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach($webLeads as $web): ?>
                                        <tr>
                                            <td class="table-text table-text-id"><div><?php echo e($i++); ?></div></td>
                                            <td class="table-text"><?php echo e($web->first_name); ?> <?php echo e($web->last_name); ?></td>
                                            <td class="table-text"><?php echo e($web->email); ?></td>
                                            <td class="table-text"><?php echo e($web->phone); ?></td>                        
                                            <td class="table-text"><?php echo e($web->location); ?></td>
                                            <td class="table-text"> <?php echo e(date('Y-m-d h:ia', strtotime($web->requested_date))); ?></td>
                                            <td class="actions">
                                                <a href="javascript:void(0);" class="on-editing save-row lead_popup" title="Edit" rel="<?php echo e($web->id); ?>"><i class="fa fa-pencil"></i></a>
                                ...
                                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-text"><?php echo e($follow->web_lead->location); ?></td>
                ...
                <div class="col-sm-8"> 
                    <div class="col-sm-6"> 
                        <div class="radio-custom radio-primary"> 
                            ...
                            <?php echo e(Form::hidden('appt_type', 1)); ?>
