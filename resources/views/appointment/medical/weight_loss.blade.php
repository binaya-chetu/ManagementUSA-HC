                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 toggle-radio-custom">
                                    <div class="col-sm-6 radio-custom radio-primary">
                                        {{ Form::radio('weight_surgeries', '1', false, ['id' => 'weight_surgeries1']) }}
                                        {{ Form::label('weight_surgeries1', 'Yes') }}
                                    </div>
                                    <div class="col-sm-6 radio-custom radio-primary">
                                        {{ Form::radio('weight_surgeries', '0', false, ['id' => 'weight_surgeries2']) }}
                        ...
                        <div class="col-sm-12 inputRow">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('liver_disease', '1', false, ['id' => 'liver_disease1']) }}
                                            {{ Form::label('liver_disease1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('liver_disease', '0', false, ['id' => 'liver_disease2']) }}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('diabetes', '1', false, ['id' => 'diabetes1']) }}
                                            {{ Form::label('diabetes1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('diabetes', '0', false, ['id' => 'diabetes2']) }}
                        ...
                        <div class="col-sm-12 inputRow">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('thyroid_treated', '1', false, ['id' => 'thyroid_treated1']) }}
                                            {{ Form::label('thyroid_treated1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('thyroid_treated', '0', false, ['id' => 'thyroid_treated2']) }}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('hormone_treated', '1', false, ['id' => 'hormone_treated1']) }}
                                            {{ Form::label('hormone_treated1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('hormone_treated', '0', false, ['id' => 'hormone_treated2']) }}
                        ...
                        <div class="col-sm-12 inputRow">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('seizures', '1', false, ['id' => 'seizures1']) }}
                                            {{ Form::label('seizures1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('seizures', '0', false, ['id' => 'seizures2']) }}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('kidney_disorder', '1', false, ['id' => 'kidney_disorder1']) }}
                                            {{ Form::label('kidney_disorder1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('kidney_disorder', '0', false, ['id' => 'kidney_disorder2']) }}
                        ...
                        <div class="col-sm-12 inputRow">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('eating_disorder', '1', false, ['id' => 'eating_disorder1']) }}
                                            {{ Form::label('eating_disorder1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('eating_disorder', '0', false, ['id' => 'eating_disorder2']) }}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('frequently_eat', '1', false, ['id' => 'frequently_eat1']) }}
                                            {{ Form::label('frequently_eat1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('frequently_eat', '0', false, ['id' => 'frequently_eat2']) }}
                        ...
                        <div class="col-sm-12 inputRow">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 toggle-radio-custom">
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('eat_more', '1', false, ['id' => 'eat_more1']) }}
                                            {{ Form::label('eat_more1', 'Yes') }} 
                                        </div>
                                        <div class="col-sm-3 radio-custom radio-primary">
                                            {{ Form::radio('eat_more', '0', false, ['id' => 'eat_more2']) }}
