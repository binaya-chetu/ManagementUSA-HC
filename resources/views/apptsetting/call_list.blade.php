...
<div id="modalCall" class="modal-block modal-block-primary mfp-hide">    
    ...
    <section class="panel panel-primary">
        ...
        <div class="panel-body">
                ...
                <div class="col-sm-8"> 
                    <div class="col-sm-6"> 
                        <div class="radio-custom radio-primary"> 
                            ...
                            {{ Form::radio('status', 'Set', false, ['id' => 'awesome', 'class' => 'callStatus required']) }}
                    ...
                    <div class="col-sm-6"> 
                        <div class="radio-custom radio-primary"> 
                            ...
                            {{ Form::radio('status', 'No Set', false, ['id' => 'very-awesome', 'class' => 'callStatus required']) }}
            ...
            <div  id="reasonCode">
                <div class="form-group">
                    {{ Form::label('reason_code', 'Reason Code', array('class' => 'col-sm-4 control-label mandatory')) }}
