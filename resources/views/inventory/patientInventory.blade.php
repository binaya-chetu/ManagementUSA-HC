                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <?php $medication = dropDownMedication();?>
                                                 ...
                                                 {{ Form::select('medicationB1', (['' => 'Select Medication'] + $medication), null, ['class' => 'form-control input required', 'id' => 'medicationB1']) }} 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 ...
                                                 {{ Form::select('medicationB2', (['' => 'Select Medication'] + $medication), null, ['class' => 'form-control input required', 'id' => 'medicationB2']) }} 
...
<!--                                    -----------------------------------------------
                                    <table class="table table-bordered table-striped mb-none">
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-text"><select class="form-control">
                                                    <option value="DD2">Select Medication</option>
                                        ...
                                        <td class="table-text"> + </td><td class="table-text"><select class="form-control">
                                                ...
                                                <option>Select Medication 2</option>
                        ...
                        <div class="toggle" data-plugin-toggle>
                            ...
                            <section class="toggle">
                                <label>Intitial Take Home Dosing   [ Deduct From Inventory Only ]              Antidotes | DD10</label>
                                <div class="toggle-content">
                                    <h4 style="text-align:center"> Take Home Test Dose A</h4>
                                    <table class="table table-bordered table-striped mb-none">
                                    ...
                                    <h4 style="text-align:center"> Take Home Test Dose B</h4>
                                    <table class="table table-bordered table-striped mb-none">
                        ...
                        <div class="toggle" data-plugin-toggle>
                            ...
                            <section class="toggle">
                                <label>Redosing</label>
                                <div class="toggle-content">
                                    <table>
                                        <tr  style="text-align:center"><td  colspan="11">Dose D</td><td  colspan="11">
                                                <select class="form-control">
                        ...
                        <div class="toggle" data-plugin-toggle>
                            ...
                            <section class="toggle">
                                <label>Prolyfic ED Therapy</label>
                                <div class="toggle-content">
                                    <h4 style="text-align:center">Treatment Log</h4>
                                    <table class="table table-bordered table-striped mb-none">
                                        <?php
                                        for ($i = 1; $i <= 12; $i++) {
                                            ?>
